...
CacheProvider = react_1.CacheProvider) {
    ...
    function augmentDocumentWithEmotionCache(Document) {
        ...
        Document.getInitialProps = (appContext) => __awaiter(this, void 0, void 0, function* () {
            ...
            const initialProps = yield super_getInitialProps(appContext);
            const emotionStyles = [
